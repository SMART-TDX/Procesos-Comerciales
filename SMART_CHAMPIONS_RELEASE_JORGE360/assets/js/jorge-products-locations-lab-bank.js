(function (global) {
  ...
  const products = [
    ...
    },
    {
      ...
      levels:['Básico 1','Básico 2','Intermedio 1','Intermedio 2','Avanzado 1'],
      ...
      tiles:[
        ...
        {icon:'📚',title:'MÓDULOS SMART ONLINE',lines:['Básico 1 · Básico 2.','Intermedio 1 · Intermedio 2 · Avanzado 1.']},
