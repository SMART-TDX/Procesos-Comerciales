/* Catálogo local y controlado de jefes de ventas Smart Mix 2026. */
(function (global) {
  "use strict";

  var FECHA_ACTUALIZACION = "2026-09-07";

  function crearJefe(id, nombre, correo, grupo, sedesORegiones, gruposAdicionales, nombresPorGrupo) {
    return Object.freeze({
      id: id,
      nombre: nombre,
      correo: correo,
      grupo: grupo,
      grupos: Object.freeze([grupo].concat(gruposAdicionales || [])),
      nombres_por_grupo: Object.freeze(nombresPorGrupo || {}),
  ...
  var jefes = Object.freeze([
    ...
    crearJefe("REG_VILLAVICENCIO_MIGUEL_ALFONSO", "Miguel Ángel Alfonso", "m.alfonso@smartidiomas.edu.co", "VILLAVICENCIO", ["REG_VILLAVICENCIO", "VILLAVICENCIO", "REG_PEREIRA", "REG_ARMENIA", "PEREIRA", "ARMENIA"], ["PEREIRA_ARMENIA"], { PEREIRA_ARMENIA: "Miguel Alfonso" }),
  ...
  function validarConfiguracion(items) {
    ...
    if (items.length !== 19) {
      errores.push("Se esperaban 19 jefes de ventas y se encontraron " + items.length + ".");
    }
    return Object.freeze({
