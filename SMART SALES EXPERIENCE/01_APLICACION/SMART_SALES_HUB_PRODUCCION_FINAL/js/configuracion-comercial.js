(function () {
  ...
  window.SMART_COMMERCIAL_CONFIG = Object.freeze({
    ...
    beneficios: Object.freeze([
      ...
      ...[1, 2, 3, 4, 5].map(function (cantidad) {
        return Object.freeze({
          id: "ebooks-" + cantidad,
          tipo: "EBOOK",
          nombre: cantidad + (cantidad === 1 ? " E-Book" : " E-Books"),
          nombrePresentacion: cantidad + (cantidad === 1 ? " E-Book" : " E-Books"),
          descripcion: "Material digital complementario.",
          valorComercial: cantidad * valoresBeneficios.ebookUnitario,
          esNinguno: false,
          activa: true,
          aprobada: true,
          seleccion: "EXCLUSIVA_TIPO",
